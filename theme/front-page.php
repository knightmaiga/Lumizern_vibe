...
<main class="homepage-main" role="main">
  ...
  <section class="lz-hero" aria-labelledby="lz-hero-title">
    <div class="container-vibe lz-hero-grid">
      <div class="lz-hero-copy">
        <p class="lz-hero-kicker">2026 Curated Discovery Engine</p>
        <h1 id="lz-hero-title"><?php esc_html_e('Shop by Vibe. Discover products that feel made for you.', 'lumizern-vibe'); ?></h1>
        <p><?php esc_html_e('Take the vibe quiz, unlock your profile, and explore premium picks with clear trust and fulfillment signals.', 'lumizern-vibe'); ?></p>
        <div class="lz-hero-actions">
          <a class="button lz-btn" href="<?php echo esc_url(home_url('/vibe-quiz/')); ?>"><?php esc_html_e('Take the Vibe Quiz', 'lumizern-vibe'); ?></a>
          <a class="button lz-btn lz-btn-ghost" href="<?php echo esc_url(function_exists('wc_get_page_permalink') ? wc_get_page_permalink('shop') : home_url('/shop/')); ?>"><?php esc_html_e('Shop All Vibes', 'lumizern-vibe'); ?></a>
        </div>
      </div>
      <div class="lz-hero-metrics" aria-label="trust metrics">
        <div class="lz-metric"><strong>50+</strong><span>Curated brands</span></div>
        <div class="lz-metric"><strong>Hybrid</strong><span>Affiliate + direct checkout</span></div>
        <div class="lz-metric"><strong>30-Day</strong><span>Returns window</span></div>
      </div>
    </div>
  </section>
